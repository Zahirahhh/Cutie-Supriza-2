...
<body>
		<h1><center>ADMINISTRATOR'S PROFILE </center></h1>
		<form action = "updateAdminprocess.php" method = "get">
			<fieldset>
				<h3>1. Please fill all information correctly.</h3>
			<fieldset>
				<legend style="font-weight:bold;">Admin Profile </legend>
			...
			<fieldset>
				<legend style="font-weight:bold;">New Profile </legend>
					<div id="adjust">Username:</div>
