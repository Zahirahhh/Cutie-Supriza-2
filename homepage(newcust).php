...
<body>
	...
	<header id="home">		
		<img src="logo2.png" alt="" onclick="audioPlay('song.mp3')" style="width:80px;height:40px;padding-top:5px;" title="CutieSupriza Logo">
		<audio id="myAudio">
			<source src="song.ogg" type="audio/ogg">
			<source src="song.mp3" type="audio/mpeg">
		Your browser does not support the audio element.
		</audio>
		<img src="click.gif" alt="" style="width:20px;height;10px;"> Click Here!
		<script>
		...
		<div style="float:right; padding-right:20px; padding-top:15px; font-size : 30px;">
			<a href="#about"><b>About Us</a>
			<a href="#product">Product</a>
			<a href="#contact">Contact Us</a>
			<a href="loginPage.php">Login</b></a>
		</div>
	</header>
	...
	<section>
		<div class="container">
			...
			<div class="quote">
				<b>"Expect nothing. Live frugally on surprise."</b>
			</div>
		</div>
		<div id="product">
				<h1><center>🍬  What Are We Selling?</center></h1>
				...
				<table>
					...
					<tr class="SignUpbutton">
						<td><a href="signupPage.php" class="button">Sign Up & <br>Order now!</td>
						<td><a href="signupPage.php" class="button">Sign Up & <br>Order now!</td>
						<td><a href="signupPage.php" class="button">Sign Up & <br>Order now!</td>
					</tr>
				</table>
		...
		<div class="partner">
			...
			<img src="farisha.jpg" alt=" " style="margin-left:350px;"title="Nur Farisha Izati - Manager">
